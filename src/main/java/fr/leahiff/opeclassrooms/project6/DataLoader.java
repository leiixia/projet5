...
public class DataLoader {
	...
	public void load() {
		...
		try {
			File data = new File("/Users/Leixia/Downloads/project6/src/main/resources/Data.Json");
			DatabaseContent databaseContent = mapper.readValue(data, DatabaseContent.class);
